...
#include "RDGRendeingExample.generated.h"
...
UCLASS(MinimalAPI, meta = (ScriptName = "RDGRenderingExample"))
class URDGRenderingExampleBlueprintLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
